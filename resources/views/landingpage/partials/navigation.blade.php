...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container-fluid navigation-style">
        ...
        <button class="navbar-toggler d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileNav"
            aria-controls="mobileNav" aria-label="Toggle navigation" style="z-index:1051;">
...
<div class="offcanvas offcanvas-start bg-light pt-5" tabindex="-1" id="mobileNav" aria-labelledby="mobileNavLabel">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav gap-3">
            <li class="nav-item">
                <a class="nav-link fw-semibold text-black d-flex align-items-center px-3 py-2" href="#home">
                    <i class="bi bi-house-door-fill me-2"></i> Home
                </a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle fw-semibold text-black" href="#about-us"
                    id="aboutUsDropdownMobile" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                    aria-expanded="false">
