            ...
            <ul class="navbar-nav align-items-center gap-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm"
                        ...
                        <li>
                            <a class="dropdown-item text-black text-center" href="{{ route('landingpage') }}" onclick="showOurTeam()">
...
<div class="offcanvas offcanvas-start bg-light" tabindex="-1" id="mobileNav" aria-labelledby="mobileNavLabel">
    ...
    <div class="offcanvas-body d-flex flex-column justify-content-between h-100">
        ...
        <div class="mt-3 d-flex flex-column gap-2">
            <a href="{{route('login-tenant')}}" class="btn btn-outline-secondary fw-semibold w-100">Tenant</a>
            <a href="{{ route('landlord-Login') }}" class="btn btn-primary fw-semibold w-100 disabled">Landlord</a>
        </div>
    </div>
</div>
</header>